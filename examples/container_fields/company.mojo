...
def main() raises:
    ...
    try:
        ...
        var sqrrl__eng = sqrrl__world.Department.create(name = "Engineering", sqrrl__members = [sqrrl__alice, sqrrl__bob], sqrrl__backup = Set(sqrrl__alice), sqrrl__lead = Optional(sqrrl__alice), tags = ["urgent", "core"], sqrrl__scores = scores_dict^, sqrrl__leads = leads_dict^, groups = [["a", "b"], ["c"]], ring = Ring[String](items=["x", "y"]), grid = Grid[String, Int](pairs=[("p", 1), ("q", 2)]))
        ...
        print(sqrrl__eng._inner[]._sqrrl__leads["primary"]._inner[].get_name())
        ...
        print(sqrrl__eng2._inner[]._sqrrl__leads["primary"]._inner[].get_name())
