...
def sqrrl__make_vendor(mut sqrrl___world: sqrrl___World, name: String) -> sqrrl__Vendor:
    var sqrrl__v = sqrrl___world.Vendor.create(name = name)
    return sqrrl__v

def sqrrl__make_project(mut sqrrl___world: sqrrl___World, name: String, priority: UInt32, sqrrl__vendor: sqrrl__Vendor, budget_cents: Int64) -> sqrrl__Project:
...
def sqrrl__hire(mut sqrrl___world: sqrrl___World, name: String, email: String, title: String, years_employed: UInt32, salary: Float64, sqrrl__dept: sqrrl__Department) raises -> sqrrl__Employee:
    ...
    var sqrrl__e = sqrrl___world.Employee.create(email = email, title = title, years_employed = years_employed, salary = salary, sqrrl__dept = sqrrl__dept, profile = profile^)
    return sqrrl__e
...
def sqrrl__log(mut sqrrl___world: sqrrl___World, message: String) raises:
    ...
    _ = sqrrl___world.AuditLog.create(message = message)
